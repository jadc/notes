...
| [Introduction To Process Skills (Making Labs)](#introduction-to-process-skills)
...
> "According to **(SOURCE)**, from the background information, if **(MANIPULATION)** occurs, then **(RESPONSE)** will happen, because **(PROVE YOUR CLAIM)**"
